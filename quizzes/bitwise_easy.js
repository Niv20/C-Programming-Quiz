...
void func()
{
    ...
    unsigned short int num = 0x1234, res = 0, i;
    ...
    correct: 1,
    hint: "הלולאה רצה פעמיים, פעם אחת עבור כל בית (byte) של המשתנה `num`. בכל פעם, היא מבודדת בית אחר ומבצעת עליו פעולת `XOR` עם מסכה שונה, בהתאם לאינדקס הלולאה.",
    explanation:
