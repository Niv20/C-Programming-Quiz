...
void main() {}`,
    ...
    explanation:
      "הקוד לא יעבור קומפילציה. ההוראה `#ifndef X` פירושה: 'אם X לא מוגדר'. כאן `X` מוגדר באמצעות `#define X 3`, ולכן התנאי לא מתקיים — והקדם־מעבד בוחר בבלוק של `#else`, כלומר, הוא משאיר את הדפסת המחרוזת `'world'`. אינטואיטיבית היינו רוצים לומר שזה מה שיודפס, אבל יש כאן קאצ'. הקריאה ל־`printf` נמצאת מחוץ לגוף של פונקציה, וכידוע כל פקודה חייבת להיות בתוך פונקציה כלשהי. אז מכיוון שמדובר כאן על שגיאה תחבירית, התוכנית אפילו לא תתקמפל.",
  },
  {
    code: `#define PI 3.14
